...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            skills::commands::skill_add_category,
            skills::commands::skill_rename_category,
            skills::commands::skill_delete_category,
            skills::commands::skill_set_skill_categories,
            skills::commands::skill_update_settings,
            skills::commands::skill_add_custom_tool,
            skills::commands::skill_remove_custom_tool,
            skills::commands::skill_set_tool_enabled_state,
            skills::commands::skill_reorder_tools,
